    ...
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <section className="relative max-w-6xl mx-auto mb-20 px-4">
        ...
        <div className="overflow-hidden rounded-lg">
           {/* Using file from design reference (Prices.jpg) which seems to be /assets/9.png or similar */}
    ...
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <section className="relative max-w-6xl mx-auto mb-16 px-4">
        ...
        <div className="overflow-hidden rounded-lg shadow-sm">
           {/* Using file from design reference (Contact us.jpg) which seems to be /assets/11.png or similar */}
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <section className="relative max-w-6xl mx-auto mb-24 px-4">
         ...
         <div className="overflow-hidden rounded-lg">
           {/* Using file from design reference (services.jpg) which seems to be /assets/12.png or similar */}
         ...
         <div className="relative">
            {/* Overlays on Image */}
             ...
             <div className="overflow-hidden rounded-lg shadow-lg">
                {/* Using file from design reference (services.jpg) which seems to be /assets/13.png or similar */}
      ...
      <section className="max-w-6xl mx-auto px-4 mb-24 relative">
          <div className="h-64 overflow-hidden rounded-xl relative">
              {/* Re-using the office image here */}
...
const App = () => {
  // Sets the initial page view
  const [activePage, setActivePage] = useState('prices'); 

  return (
    <div className="bg-gray-100">
      {/* Renders the single Navbar component and passes the page switching function */}
      <Navbar setActivePage={setActivePage} />
      
      {/* Conditionally renders the active page */}
